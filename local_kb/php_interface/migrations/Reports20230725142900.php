...
class Reports20230725142900 extends Version
{
  ...
  array (
    ...
    array (
      'NAME' => 'Otchety',
      'SECTION_NAME' => '',
      'ELEMENT_NAME' => 'Otchety',
    ),
  ),
));
        $iblockId = $helper->Iblock()->saveIblock(array (
  'IBLOCK_TYPE_ID' => 'otchety',
  'LID' => 
  array (
    0 => 's1',
  ),
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/otchety/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/otchety/detail.php?ID=#ELEMENT_ID#',
  ...
  'EXTERNAL_ID' => NULL,
  'LANG_DIR' => '/',
  'SERVER_NAME' => 'portal.krasnoe-beloe.ru',
  'IPROPERTY_TEMPLATES' => 
  array (
  ),
  ...
  array (
    ...
    'PROPERTY_ACCESS' => 'Доступ к отчету',
    'PROPERTY_65' => 'Таблица отчета',
    'PROPERTY_FILTERS' => 'Фильтры',
  ),
  'Анонс|edit5' => 
  array (
