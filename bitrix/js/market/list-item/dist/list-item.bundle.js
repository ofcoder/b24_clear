this.BX = this.BX || {};
(function (exports,market_popupInstall,market_popupUninstall,ui_vue3_pinia,market_installStore,market_uninstallStore,market_ratingStars,ui_iconSet_api_vue,main_popup,market_marketLinks) {
	'use strict';
	...
	var ListItem = {
	  ...
	  methods: _objectSpread(_objectSpread({
	    getDetailLink: function getDetailLink(appCode, isSiteTemplate) {
	      var params = {
	        from: this.fromParam
	      };
	      return market_marketLinks.MarketLinks.appDetail(appCode, isSiteTemplate, params);
	    },
	      ...
	      if (this.item.BUTTONS.DELETE === 'Y') {
	        menu.push({
	          ...
	          onclick: function onclick() {
	            ...
	            _this.setDeleteActionInfo(_this.item.ADDITIONAL_ACTION_DEL);
	            _this.deleteAction(_this.item.CODE, _this.$root.currentUri);
	          }
	        });
	      }
	      if (menu.length > 0) {
	  ...
	  }, ui_vue3_pinia.mapActions(market_installStore.marketInstallState, ['showInstallPopup', 'setAppInfo'])), ui_vue3_pinia.mapActions(market_uninstallStore.marketUninstallState, ['deleteAction', 'setDeleteActionInfo'])),
...
}((this.BX.Market = this.BX.Market || {}),BX.Market,BX.Market,BX.Vue3.Pinia,BX.Market,BX.Market,BX.Market,BX.UI.IconSet,BX.Main,BX.Market));
